...
namespace PinPayments.Console
{
    class Program
    {
        static void Main(string[] args)
		{
			...
			response = ps.Charge(new PostCharge { Amount = 1500, CardToken = respCardCreate.Response.Token, Currency = "AUD", Description = "Desc", Email = "email@test.com", IPAddress = "127.0.0.1" });
			System.Console.WriteLine(response.Charge.Success);
